...
<section class="container">
    ...
    <div class="blog-details">
        <h3 class="anim-title-3">Genießen Sie exquisites Dinieren</h3>
    ...
    <div class="row" id="containerAround">
        <div class="col-md-8">
            <div class="blog-content" id="scrollGaleria">
                ...
                <img class="imagesZoom" src="{{ asset('assets/img/blog_detalis.jpg') }}" alt="...">
                <div class="ak-height-75 ak-height-lg-30"></div>
                <p>Bei Felicità glauben wir, dass ein außergewöhnliches Essen weit mehr ist als die Summe seiner
                    Zutaten. Es ist die Sorgfalt, mit der jedes Gericht komponiert wird, die Wärme des Raumes und
                    die Freude, die entsteht, wenn Freunde und Familie sich an einem Tisch versammeln. Unsere
                    Küche verbindet mediterrane Tradition mit einem modernen Gespür für Aromen, damit jeder Besuch
                    zu einem Moment wird, an den man sich gerne erinnert. Von der Auswahl der frischesten
                    Zutaten bis zur letzten Geste am Tisch legen wir bei allem, was wir tun, größten Wert
                    auf Genuss und Gastfreundschaft.
                </p>
                <div class="ak-height-75 ak-height-lg-30"></div>
                    ...
                    <div class="testimonial-section">
                        ...
                        <div class="testimonial-info-section">
                            <div class="testimonial-info">
                                <p class="testimonial-info-subtitle">„Unser talentiertes Team vereint
                                    Leidenschaft und Handwerkskunst, um jedes Gericht mit größter Sorgfalt
                                    zuzubereiten – von der Auswahl der Zutaten bis zur perfekten Präsentation
                                    auf dem Teller.“</p>
                            </div>
                        </div>
                        <div class="testimonial-icon-1">
                ...
                <div class="ak-height-75 ak-height-lg-30"></div>
                <h4 class="anim-title-2 ak-white-color">Genießen Sie exquisites Dinieren</h4>
                ...
                <p>Bei Felicità glauben wir, dass ein außergewöhnliches Essen weit mehr ist als die Summe seiner
                    ...
                    zu einem Moment wird, an den man sich gerne erinnert. Von der Auswahl der frischesten
                    Zutaten bis zur letzten Geste am Tisch legen wir bei allem, was wir tun, größten Wert
                    auf Genuss und Gastfreundschaft.</p>
                <div class="ak-height-75 ak-height-lg-30"></div>
                <!-- Start Video -->
                <div>
                    <div class="video-section">
                        <img src="{{ asset('assets/img/blog_details_video.jpg') }}" alt="..." class="video-section-bg-img ak-bg imagesZoom">
                ...
                <!-- End Video -->
                <div class="ak-height-75 ak-height-lg-30"></div>
                <p>Ob ein romantisches Abendessen zu zweit oder eine festliche Feier mit der ganzen Familie –
                    bei Felicità finden Sie stets den passenden Rahmen für unvergessliche Stunden bei gutem Essen</p>
                <div class="ak-height-75 ak-height-lg-30"></div>
                <div class="blog-details-border"></div>
                ...
                <div>
                    <h3 class="anim-title-2 ak-white-color">Kommentar (1)</h3>
                    <p>Bisher ein Kommentar! Hinterlassen Sie gerne auch Ihre Gedanken. </p>
                    <ol class="comment-list">
                        <li class="comment">
                            <div class="comment-body">
                                <div class="comment-author vcard">
                                    <img class="avatar" src="{{ asset('assets/img/author.png') }}" alt="Autor">
                                    <a href="#" class="url">George Steven</a>
                                </div>
                                <div class="comment-meta">
                                    <a href="#">17. Sept. 2023 um 10:59 Uhr </a>
                                </div>
                                <p>Ein wunderbarer Beitrag! Wir waren letzte Woche bei Felicità zu Gast und
                                    waren restlos begeistert – von der herzlichen Atmosphäre bis zum
                                    letzten Gang.
                                </p>
                                <div class="reply"><a class="comment-reply-link" href="#">
                                        Antworten
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 5.74707H8.5C10.0913 5.74707 11.6174 6.37921 12.7426 7.50443C13.8679 8.62965 14.5 10.1558 14.5 11.7471V13.2471M1 5.74707L5.5 10.2471M1 5.74707L5.5 1.24707" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </a></div>
                            </div>
                            <ol class="children">
                                <li class="comment">
                                    <div class="comment-body">
                                        <div class="comment-author vcard">
                                            <img class="avatar" src="{{ asset('assets/img/testimonial_1.jpg') }}" alt="Autor">
                                            <a href="#" class="url">Sarah Taylor</a>
                                        </div>
                                        <div class="comment-meta">
                                            <a href="#">17. Sept. 2023 um 17:59 Uhr </a>
                                        </div>
                                        <p>Danke dir! 🙂</p>
                                        <div class="reply"><a class="comment-reply-link" href="#">
                                                Antworten
                ...
                <div class="contact-content">
                    <div class="contact-form">
                        <h2 class="contact-form-title anim-title-2 ak-white-color">Kommentar hinterlassen</h2>
                        <from action="jsfdjks.php" method="post">
                            <div class="from-input">
                                <input placeholder="Ihr Name" class="col-md-5 col-12" type="text" name="fristname" id="fristname">
                                <input placeholder="Ihre E-Mail" class="col-md-5 col-12" type="email" name="email" id="emailid">
                            </div>
                            <div class="col-md-12">
                                <textarea name="textarea" rows="5" class="col-12 col-md-10" placeholder="Ihr Kommentar"></textarea>
                                </textarea>
                            </div>
                            <div class="ak-height-40 ak-height-lg-20"></div>
                            <div class="ak-btn style-5">
                                <button type="submit">Kommentar absenden
                                </button>
                            </div>
                        </from>
                    </div>
...
<div class="container">
    ...
    <div class="ak-section-heading ak-style-1 ak-type-1">
        ...
        <h2 class="ak-section-title anim-title">Ähnliche Beiträge</h2>
    </div>
